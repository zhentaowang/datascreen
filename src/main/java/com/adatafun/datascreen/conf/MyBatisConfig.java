package com.adatafun.datascreen.conf;
...
public class MyBatisConfig {
    ...
    public MapperScannerConfigurer mapperScannerConfigurer(){
        ...
        mapperScannerConfigurer.setBasePackage("com.adatafun.datascreen.mapper");
    ...
    public SqlSessionFactoryBean sqlSessionFactoryBean(DruidDataSource dataSource,ResourceLoader resourceLoader,ResourcePatternResolver resourcePatternResolver) throws Exception{
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.adatafun.datascreen.model");
